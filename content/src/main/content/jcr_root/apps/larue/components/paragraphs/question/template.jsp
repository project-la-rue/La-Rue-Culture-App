...
<%   
   ...
   String receiver  = properties.get("support-contact","");
   String email  = properties.get("support-email","");
%>
<div class="larue-question" >
    <div class="label">QUESTIONS?</div>
    <a class="email button" href="mailto:<%= email %>">EMAIL <%= receiver %></a>
</div>